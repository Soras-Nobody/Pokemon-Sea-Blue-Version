...
static const u8 sText_TeamGainedEXP[] = _("All eligible party members\ngained some EXP. Points!\p");
static const u8 sText_PkmnReachedLevelCap[] = _("{PLAY_SE SE_EXP_MAX}{B_BUFF1} stopped\ngaining EXP. Points!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_PKMNREACHEDLEVELCAP - BATTLESTRINGS_TABLE_START]           = sText_PkmnReachedLevelCap,
